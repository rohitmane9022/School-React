...
const   Carousel = ({Carousels}) => {
  return (
    <section className="w-[80%] mx-auto py-10">
      ...
      <div className="py-10 flex flex-wrap justify-center lg:justify-between">
        {Carousels.map(item=>(
          <div key={item.length} className="carousel-item w-96 h-96 border-white object-cover rounded-md overflow-hidden bg-white shadow-xl my-6">
